...
if(empty($message['message'])){
    $output['success'] = false;
    $output['message'][] = 'invalid message key';
}

$message['subject'] = filter_var($_POST['message'], FILTER_SANITIZE_STRING);
...
//only necesary if no subject provided then pick one of these two.
//$message['subject'] = $message['name']." has sent you a message on your portfolio"; //makes a subject field.
//$message['subject'] = substr($message['message'],0,78) //takes first 78 characters to be placed in subject field.
